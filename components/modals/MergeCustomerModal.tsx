  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in">
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 max-w-lg w-full overflow-hidden flex flex-col max-h-[94vh] sm:max-h-[92vh]">
        ...
        <div className="p-4 sm:p-5 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <div>
              ...
              <h3 className="text-base sm:text-lg font-bold text-slate-900">Merge Duplicate Profiles</h3>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Merge Form */}
        <form onSubmit={handleMerge} className="p-4 sm:p-6 overflow-y-auto space-y-4 flex-1">
          <div>
          ...
          <div className="pt-2 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2 sm:gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-amber-600 hover:bg-amber-700 text-white font-bold text-xs shadow-md font-mono uppercase tracking-wider disabled:opacity-40 text-center"
            >
