      ...
      <div className="page-intro">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className="px-3.5 py-2.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 font-bold text-xs flex items-center gap-1.5 shadow-sm font-mono"
          >
            <Sliders className="w-3.5 h-3.5 text-slate-500" />
            <span>Field Mapping Config</span>
          </button>

          <button
            onClick={handleReconcileAll}
            className="px-3.5 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs flex items-center gap-1.5 shadow-sm font-mono"
          >
            <RefreshCw className="w-3.5 h-3.5 text-emerald-400" />
            <span>Reconcile All Inbound</span>
          </button>
      ...
      {showMappingModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in">
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 max-w-xl w-full p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs max-h-80 overflow-y-auto pr-1">
              <div>
